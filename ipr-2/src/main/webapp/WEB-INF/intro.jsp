...
<div class="position-relative top-50 start-50 translate-middle shadow-lg p-3 mb-5 bg-body rounded-3">
    ...
    <div class="mb-3">
        <p class="fw-bold fs-5 text-muted d-flex justify-content-center"><fmt:message bundle="${lang}" key="lang.intro.hello"/></p>
        <p class="fw-bold fs-5 text-muted d-flex justify-content-center"><fmt:message bundle="${lang}" key="lang.intro.demand"/></p>
    </div>
