...
<%--&lt;%&ndash;hotel <%= hotelId %>&ndash;%&gt;--%>
<%--&lt;%&ndash;room <%= roomId %>&ndash;%&gt;--%>
<%--<div class="col mx-4">--%>
<%--    <div class="row mb-4">--%>
<%--        <div class="card p-0">--%>
...
<%--                        &lt;%&ndash;<form method="post" action="/rooms">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <input type="hidden" name="hotel_id" value="<%= hotel.getId() %>">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <button type="submit" class="btn btn-outline-primary">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <fmt:message bundle="${lang}" key="lang.hotels.redirect"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </form>&ndash;%&gt;--%>
